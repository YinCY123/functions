...
markers <- list(
    ...
    "EC arterial" = c("DDK2", "IGFBP3", "FBLN5", "CLDN10", "SERPINE2", "GJA5", "CXCL2", "BMX", "LTBP4", "HEY1", "SOX5"), 
    "EC capillary" = c("AFF3", "ADGRL2", "BTNL9", "RGCC", "ADGRF5", "KIAA1217"), 
    "EC venous" = c("CLU", "ACKR1", "IGFBP7"), 
    ...
    "Basal" = c("KRT5", "KRT15", "KRT16", "KRT16", "KRT6A", "KRT7", "S100A2", "TP63"), 
